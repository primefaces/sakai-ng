...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'pantalla1', data: { breadcrumb: 'Pantalla1' }, loadChildren: () => import('./pantalla1/pantalla1.module').then(m => m.pantalla1DemoModule) },
        { path: 'ConsultaUsuarios', data: { breadcrumb: 'ConsultaUsuarios' }, loadChildren: () => import('./ConsultaUsuarios/ConsultaUsuarios.module').then(m => m.ConsultaUsuariosDemoModule) },
        { path: 'ListaOficiales', data: { breadcrumb: 'ListaOficiales' }, loadChildren: () => import('./ListaOficiales/ListaOficiales.module').then(m => m.ListaOficialesDemoModule) },
