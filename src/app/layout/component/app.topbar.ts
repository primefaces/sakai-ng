...
import { AuthModule } from "../../pages/ModuloAuth/auth/auth.module";

@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator, AuthModule],
    template: ` 
    <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            ...
            <button (click)=" profileMenuVisible = false " class="layout-topbar-menu-button layout-topbar-action" pStyleClass="@next" enterFromClass="hidden" enterActiveClass="animate-scalein" leaveToClass="hidden" leaveActiveClass="animate-fadeout" [hideOnOutsideClick]="true">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <app-auth-profile *ngIf="profileMenuVisible" [visible]="profileMenuVisible" (close)="profileMenuVisible = false" ></app-auth-profile>
                </div>
            </div>
        </div>
    </div>
